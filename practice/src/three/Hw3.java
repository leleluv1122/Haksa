...
/*
 * public class Hw3 { static Object[][] orr = new Object[3][2];
 * 
 * static void addData(int count) { for (int i = 0; i < count; i++) { //orr[i] =
 * new Object[2];
 * 
 * orr[i][0] = new Integer(i); orr[i][1] = String.valueOf(i); } }
 * 
 * static int findIndex(int value) { for(int i=0;i<3;i++) {
 * 
 * } }
 * 
 * public static void main(String[] args) {
